...
namespace nts
{
    ...
    {
        _link.at(2)  = new Not(this, 1, this, 2);
        _link.at(3)  = new Not(this, 5, this, 6);
        _link.at(9)  = new Not(this, 8, this, 9);
        _link.at(10) = new Not(this, 12, this, 13);
    }
    
    TriState C4069::compute(size_t cur)
    {
        if (cur < 1 || cur > 13)
    ...
    void C4069::setLink(size_t pin, IComponent &component, size_t target)
    {
        switch (pin) {
